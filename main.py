...
pygame.display.set_caption("Santa y la aventura navideña")

# Load images
RED_SPACE_SHIP = pygame.image.load(os.path.join("assets", "present.png"))
GREEN_SPACE_SHIP = pygame.image.load(os.path.join("assets", "candy.png"))
BLUE_SPACE_SHIP = pygame.image.load(os.path.join("assets", "ginger.png"))

# Player player
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("assets", "santa.png"))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Click en mouse para comenzar.", 1, (255,255,255))
